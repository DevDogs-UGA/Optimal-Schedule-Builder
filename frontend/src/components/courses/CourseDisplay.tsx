    ...
    <section className="flex flex-col gap-8 md:flex-row">
      ...
      <div className="w-full md:w-1/3">
        ...
        <div className="relative">
          ...
          <div className="no-scrollbar relative flex flex-1 flex-col overflow-x-hidden overflow-y-scroll scroll-smooth rounded-tl-lg rounded-tr-lg border-2 border-b-0 border-[#A79A9D] bg-white py-4">
            {/*Course item */}
            {courses.map((course) => (
              <RegisteredClass
                key={course.courseId}
          ...
          <div className="absolute bottom-0 left-0 top-4 flex h-6 w-full justify-center rounded-bl-lg rounded-br-lg border-2 border-t-0 border-[#A79A9D] bg-white">
            {courses.length > 5 && (
